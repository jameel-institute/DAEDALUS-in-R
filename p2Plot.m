function f=p2Plot(data,f1,p2,g1,cost)
...
%hh1 = plot(t1,I1,'-','linewidth',lw,'color','red');
%hh0 = plot(t1,60000*p3,'-','linewidth',lw,'color','blue');
%hh0 = plot(t1,60000*beta,'-','linewidth',lw,'color','blue');
...
% t = text(-22.3,86.6,strvcat('Singapore','Covid Wildtype','Custom Strategy'),'FontSize',fs);
...
ax = gca;
ax.Position = [0.20 0.20 0.80 0.70];
...
grid on;
box on;
set(gca,'xticklabels',{'Year 1','Year 2','Year 3'});       
